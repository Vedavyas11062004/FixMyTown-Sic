    ...
    <div>
      ...
      <div className="grid grid-nogutter surface-0 text-800 mt-5">
        <div className="col-12 md:col-6 p-6 text-center md:text-left flex align-items-center ">
          <section>
            ...
            Road Renewal Revolution: 
            </span>
            <div className="text-6xl text-primary font-bold mb-3">
            Filling the Gaps for Sustainable Transportation
            </div>
      ...
      >
        <div className="mb-3 font-bold text-5xl">
          <span className="text-900">Smooth Roads, </span>
          <span className="text-primary">Bright Tomorrow</span>
        </div>
        ...
        <div className="grid">
          <div className="col-12 md:col-4 mb-4 px-5">
            ...
            <span className="text-800 line-height-3">
              Find and report a potholes hotspot and make a difference,Be a
          ...
          <div className="col-12 md:col-4 mb-4 px-5">
            ...
            Snap a pic of potholes and save it on your phone. By sharing images of potholes, you contribute to our mission of ensuring smooth and sustainable transportation. Together, we can create safer roads for all.
            </span>
          </div>
          <div className="col-12 md:col-4 mb-4 px-5">
            <span
            ...
            <span className="text-700 line-height-3">
            Upload a photo of the pothole along with its location details in the provided form. Please include a brief description and the precise location of the pothole in the image you upload. Your submission will contribute to our efforts in filling potholes and maintaining road safety.
            </span>
          </div>
        </div>
      </div>
